...
## CAD Model:
  It is made with a sandwich-style mount, using supports to elevate the PCB so the USB port can fit, and so the switches and everything else have the necessary tolerance. 
